...
jrc:
	cp source/conf_jrc.py    source/conf.py
	cp source/index_jrc.rst  source/index.rst

lc:    
	cp source/conf_lc.py     source/conf.py
	cp source/index_lc.rst   source/index.rst
