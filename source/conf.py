...
# pixels large.
html_favicon = '../themes/geosolutions/static/img/favicon.ico'
...
latex_documents = [('index', 'doc-lci.tex', u'LineComune Documentation', u'ETj (GeoSolutions)', 'manual')]


# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'geosolutions.png'
...
man_pages = [('index', 'doc-lc', u'LineaComune Documentation', [u'ETj (GeoSolutions)'], 1)]
